          ...
          <div className="hero-grid-layout">
            ...
            <div className="pointer-events-auto">
              ...
              <motion.h1 
                ...
                style={{ fontSize: "clamp(3.5rem, 5vw, 5rem)", lineHeight: 1.1 }}
              >
                Find Your <br />
                <span className="fst-italic fw-light" style={{ color: "var(--h-saffron)" }}>Altitude.</span>
              </motion.h1>
              ...
              <motion.p
                ...
                style={{ color: "rgba(255, 250, 243, 0.82)", maxWidth: "540px", fontSize: "1.15rem", lineHeight: "1.6" }}
              >
              ...
              >
                <motion.button
                  ...
                  whileHover={{ scale: 1.05, boxShadow: '0 0 25px rgba(226, 196, 140, 0.4)' }}
                  whileTap={{ scale: 0.95 }}
                  className="rounded-pill fw-bold border-0 position-relative overflow-hidden"
                  style={{
                    padding: "16px 36px",
                    fontSize: "1.1rem",
                    background: "linear-gradient(135deg, var(--h-saffron) 0%, var(--h-saffron) 100%)",
                    color: "var(--white)",
                    cursor: "pointer",
                    letterSpacing: "0.5px",
            ...
            <div className="pointer-events-auto position-relative d-flex flex-column align-items-center w-100">
              <div className="position-relative w-100 d-flex justify-content-center align-items-start" style={{ minHeight: "480px" }}>
                <motion.div
                  animate={{ y: [-10, 10, -10] }}
                ...
                <div className="d-none d-lg-block w-100 h-100 position-absolute top-0 start-0 pointer-events-none d-flex justify-content-center">
                  <div className="position-relative w-100 h-100" style={{ maxWidth: "470px" }}>
                    <motion.div
                    ...
                    >
                      <span className="d-block small text-uppercase mb-1" style={{ color: "rgba(255, 255, 255, 0.7)", letterSpacing: "1px" }}>Highest Peak</span>
                      <h3 className="h5 mb-0 fw-semibold" style={{ color: "var(--h-saffron)" }}>Reo Purgyil</h3>
                    </motion.div>
                    ...
                    >
                      <span className="d-block small text-uppercase mb-1" style={{ color: "rgba(255, 255, 255, 0.6)", letterSpacing: "1px" }}>Vibe</span>
                      <h3 className="h5 mb-0 fw-semibold" style={{ color: "var(--h-saffron)" }}>Serene & Untamed</h3>
                    </motion.div>
                  </div>
                </div>
              </div>
              ...
              {/* Mobile Static Cards */}
              <div className="d-flex d-lg-none flex-column flex-sm-row gap-3 w-100 mt-4 px-2" style={{ maxWidth: "470px" }}>
                <div
                ...
                >
                  <span className="d-block small text-uppercase mb-1" style={{ color: "rgba(255, 255, 255, 0.6)", letterSpacing: "1px" }}>Highest Peak</span>
                  <h3 className="h5 mb-0 fw-semibold" style={{ color: "var(--h-saffron)" }}>Reo Purgyil</h3>
                </div>
                <div
                  className="flex-grow-1"
